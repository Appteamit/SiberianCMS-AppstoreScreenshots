...
var myDropzone = new Dropzone("#convertImages", {
  ...
  maxFilesize: 2, // MB
  dictDefaultMessage: "Drop your images here (even more than one)! <br> Converts all your images to the 2 required formats: <br> 5.5, 6.5 inch as required by the Apple App Store.",
  parallelUploads: 5,
  uploadMultiple: true,
  maxFiles: 5,
