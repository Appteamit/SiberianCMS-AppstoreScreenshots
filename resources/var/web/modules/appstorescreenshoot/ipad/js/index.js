...
var myDropzone = new Dropzone("#convertImages", {
  ...
  maxFilesize: 2, // MB
  dictDefaultMessage: "Drop your images here (even more than one)! <br> Converts all your images to the 2 required formats: <br> 12.9 inch (iPad Pro 2nd/3nd Gen.) as required by the Apple App Store.",
  parallelUploads: 5,
  uploadMultiple: true,
  maxFiles: 5,
